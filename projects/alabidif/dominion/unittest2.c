...
int main()
{
    ...
    printf("\n");
    printf("=========================================\n");
    printf("Unit Test 2: Minion - int minionCard()\n");
    printf("=========================================\n");
    printf("\n");
    ...
    printf("Calling minionCard(1, 0, &testState, 3, 0)\n");
#endif
    minionCard(choice1, choice2, &testState, 3, 0);
#if (NOISY_TEST == 1)
    printHand(0, &testState);
    printf("\n");
#endif
    ...
    printHand(0, &testState);
    printf("Calling minionCard(0, 1, &testState, 3, 0)\n");
#endif
    minionCard(choice1, choice2, &testState, 3, 0);
#if (NOISY_TEST == 1)
    printHand(0, &testState);
