...
int main()
{
    ...
    printf("\n");
    printf("==============================================\n");
    printf("Unit Test 3: Ambassador - int ambassadorCard()\n");
    printf("==============================================\n");
    printf("\n");
    ...
    printf("Calling ambassadorCard(choice1, choice2, &testState, handPos, currentPlayer)\n");
#endif
    ...
    printf("Test 1: ");
    assertTrue(ambassadorCard(choice1, choice2, &testState, handPos, currentPlayer), -1);
#if (NOISY_TEST == 1)
    ...
    choice2 = 2; //return 2 copies to supply
    handPos = 2; //position of Ambassador card we want to play
    ambassadorCard(choice1, choice2, &testState, handPos, currentPlayer);
    printf("Test 4: ");
