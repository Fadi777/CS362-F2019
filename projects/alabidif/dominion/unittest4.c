...
int main()
{
    ...
    printf("\n");
    printf("=========================================\n");
    printf("Unit Test 4: Tribute - int tributeCard()\n");
    printf("=========================================\n");
    printf("\n");
    ...
    printf("Calling tributeCard(&testState, nextPlayer, currentPlayer, tributeRevealedCards)\n");
#endif
    tributeCard(&testState, nextPlayer, currentPlayer, tributeRevealedCards);
