...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case minion:
        minionCard(choice1, choice2, handPos, state);
        return 0;
    ...
    case tribute:
        tributeCard(state, nextPlayer, tributeRevealedCards[2]);
        return 0;
...
int minionCard(int choice1, int choice2, int handPos, struct gameState, *state)
{
    int i;
    int j;
    int currentPlayer = whoseTurn(state);
...
int tributeCard(struct gameState *state, int nextPlayer, int tributeRevealedCards[2])
{
    int i;
    int currentPlayer = whoseTurn(state);
